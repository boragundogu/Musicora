...
final class DetailView: UIView {
    ...
    private func setupUI() {
        ...
        [imageView, songLabel, artistLabel, previousButton, playButton, nextButton,
        ...
        artistLabel.snp.makeConstraints { make in
            make.top.equalTo(songLabel.snp.bottom).offset(20)
    ...
    func configureView(with song: Song) {
        songLabel.text = song.trackName
        artistLabel.text = song.artistName
        
        if let url = URL(string: song.artworkUrl100.replacingOccurrences(of: "100x100bb", with: "600x600bb")) {
